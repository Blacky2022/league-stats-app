...
export function ChampionsPerformance() {
	...
	const handleSearch = event => {
		...
		const filtered = championSummary
			? championSummary.filter(champion => champion.name.toLowerCase().includes(query.toLowerCase()))
			: []
	...
	return (
		<>
			...
			<div className='container'>
				<input className='search-input' type='text' value={searchQuery} onChange={handleSearch} placeholder='Search champion...' />
